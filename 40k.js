...
{   
    ...
    //document.getElementById("rando1").innerHTML = "Rando 1 test =" + rando1
    //code was for validation to see number along with phonetic alphabet
    if (rando1 ==1)
    ...
    //obj1 = obj1 + rando1; atempt to make obj1 = greater than zero to bypass if statement and and lock in number//
   ...
   // {
        ...
        {   
            ...
            //document.getElementById("rando2").innerHTML = "Rando 2 test =" + rando2
            //code was for validation to see number along with phonetic alphabet
            if (rando2 ==1)
...
//{
    ...
    {   
        ...
        //document.getElementById("rando3").innerHTML = "Rando 3 test =" + rando3
        //code was for validation to see number along with phonetic alphabet
        if (rando3 ==1)
...
//}
//while (rando3 == rando1 || rando2)

if (obj4 ==0)
{   
    var rando4 = Math.floor(Math.random() *5)+1;
    //document.getElementById("rando4").innerHTML = "Rando 4 test =" + rando4
    //code was for validation to see number along with phonetic alphabet
    if (rando4 ==1)
...
{   
    ...
    //document.getElementById("rando5").innerHTML = "Rando 5 test =" + rando5
    //code was for validation to see number along with phonetic alphabet
    if (rando5 ==1)
...
//while (rando5 == rando1 || rando5 == rando2 || rando5 == rando3 || rando5 == rando4);
...
function objReset()
{
    document.getElementById("incoming").innerHTML = "Incoming Transmission--";
